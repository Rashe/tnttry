...
$lang['openid_nist_level'] = "<p>The NIST auth level returned by the server is: <i>%s</i></p>";
$lang['openid_auth_age'] = "<p>The authentication age returned by the server is: <i>%s</i></p>";
